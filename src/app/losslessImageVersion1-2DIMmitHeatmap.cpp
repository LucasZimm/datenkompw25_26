...
void encode(const std::string& inname, const std::string& outname)
{
    ...
    Prediction pred(img.getWidth(), img.getHeight(), img.getData(), false);  // isDecoding = false
...
void decode( const std::string& inname, const std::string& outname )
{
  ...
  Prediction      pred( img.getWidth(), img.getHeight(), img.getData(), true );  // isDecoding = true
